    ...
    <main className="">
      <div className="container py-[1.875rem] px-4 border-dashed border-outline border-b border-r border-l">
        ...
        <section className="flex flex-col gap-8 py-[32px]">
          <h2 className="text-xs uppercase font-medium text-accent-foreground">Sobre</h2>
      ...
      <section className="container py-[1.875rem] px-4 border-dashed border-outline border-b border-r border-l flex flex-col gap-8">
        <h2 className="text-xs uppercase font-medium text-accent-foreground">Experiência</h2>
      ...
      <section className="container py-[1.875rem] px-4 border-dashed border-outline border-b border-r border-l flex flex-col gap-8">
        <h2 className="text-xs uppercase font-medium text-accent-foreground">Tecnologias</h2>
        <TechStackCarrousel data={data.techStack} />
      </section>
      <section className="container py-[1.875rem] px-4 border-dashed border-outline border-b border-r border-l flex flex-col gap-8">
        <h2 className="text-xs uppercase font-medium text-accent-foreground">Projetos em Destaque</h2>
